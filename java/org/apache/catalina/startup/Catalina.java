...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        // 解析Server/GlobalNamingResources节点， 创建JNDI
        ...
        // 解析Server/Service/Listener节点，创建Service的生命周期监听器
        ...
        //Executor
        // 解析Server/Service/Executor节点，创建Executor
        ...
        // 解析Server/Service/Connector节点，创建Connector
        ...
        // 解析Server/Service/SSLHostConfig节点，创建SSLHostConfig
        ...
        digester.addSetNext("Server/Service/Connector/SSLHostConfig/OpenSSLConf/OpenSSLConfCmd",
                            "addCmd",
                            "org.apache.tomcat.util.net.openssl.OpenSSLConfCmd");
        // 解析Server/Service/Connector/Listener节点，创建连接器的生命周期监听器
        ...
        // 解析Server/GlobalNamingResources/下的节点
        digester.addRuleSet(new NamingRuleSet("Server/GlobalNamingResources/"));
        // 解析Server/Service/下的Engine节点
        digester.addRuleSet(new EngineRuleSet("Server/Service/"));
        // 解析Server/Service/Engine/下的Host节点
        digester.addRuleSet(new HostRuleSet("Server/Service/Engine/"));
        // 解析Server/Service/Engine/Host/下的Context节点
    ...
    public void load() {
        ...
        // Create and execute our Digester
        // 创建Digester，设置conf/server.xml文件的解析规则
        ...
        try {
            ...
            try {
                ...
                // 将Catalina实例放入digester栈顶，解析server.xml创建的Server对象会设置到Catalina实例中
                digester.push(this);
                // 解析server.xml
        ...
        // 设置Server实例的CatalinaHome目录
        getServer().setCatalinaHome(Bootstrap.getCatalinaHomeFile());
        // 设置Server实例的CatalinaBase目录
